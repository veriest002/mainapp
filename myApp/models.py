...
class Survey(models.Model):
    ...
    def get_feedback(self):
        return ('survey-feedback', [self.pk])
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(Question, verbose_name=_("Question"),related_name="answers",on_delete=models.PROTECT)
    response = models.ForeignKey(Response, verbose_name=_("Response"),related_name="answers",on_delete=models.PROTECT)
    created = models.DateTimeField(_("Creation date"), auto_now_add=True)
    updated = models.DateTimeField(_("Update date"), auto_now=True)
